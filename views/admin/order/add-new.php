								...
								<div id="list-printcurcuit">
									<div class="col-sm-12 order-item" data-sort="1">
										...
										<div class=" form-group row">
											<label class="col-xs-2 col-form-label" for="name-printcurcuit-0"><b>Tên mạch</b></label>
											<div class="col-xs-10"><input type="text" id="name-printcurcuit-0" name="printcurcuit_0[name]" class="form-control"></div>
										</div>
										<div class=" form-group row">
											<label class="col-xs-2 col-form-label" for="num-printcurcuit-0"><b>Số lượng</b></label>
											<div class="col-xs-10"><input type="number" id="num-printcurcuit-0" name="printcurcuit_0[num]" class="form-control" value="1" onchange="change_price(this)"></div>
										</div>
